...
const Admin = () => {
  ...
  const handleLogin = (e) => {
    ...
    fetch("http://localhost:4000/Admin")
      ...
      .then((data) => {
        ...
        if (foundUser) {
          // Login successful
          Authentication.adminLogin(() => {  // Change this line
            navigate("/todo");
          });
  ...
  return (
    ...
    <div className="container border-1 border" id="cont">
      <h5 className="ms-3 p-5" style={{color:"red"}}>Note!Only Admins can use this Page</h5>      <div className="row">
        <div className="col-12 py-5 shadow mb-5 my-custom-shadow">
          <h2 className="p-3">TITAN ADMIN</h2>
